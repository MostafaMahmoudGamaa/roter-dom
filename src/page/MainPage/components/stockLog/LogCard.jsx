      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 relative z-10">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-red-50 rounded-xl">
              <span className="text-gray-600 font-medium">المباع</span>
              <span className="text-xl font-bold text-red-700">{before.solid}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-red-50 rounded-xl">
              <span className="text-gray-600 font-medium">اجمالي فلوس المباع</span>
              <span className="text-xl font-bold text-red-700">{before.totalMoney + "$"}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-red-50 rounded-xl">
        ...
        >
          ...
          <div className="space-y-4">
           { trader?.mlian > 0 ?  (<div className="flex justify-between items-center p-3 bg-blue-50 rounded-xl">
              <span className="text-gray-600 font-medium">مليان</span>
              <span className="text-xl font-bold text-blue-600">{trader.mlian}</span>
            </div>) : ""}

            {trader?.fadi > 0 ? (<div className="flex justify-between items-center p-3 bg-blue-50 rounded-xl">
              <span className="text-gray-600 font-medium">فاضي</span>
              <span className="text-xl font-bold text-blue-500">{trader.fadi}</span>
            </div>) :""}

           {trader?.money > 0 ? ( <div className="flex justify-between items-center p-3 bg-blue-50 rounded-xl">
              <span className="text-gray-600 font-medium">فلوس</span>
        ...
        >
          ...
          <div className="  space-y-4 ">
            ...
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-xl">
              <span className="text-gray-600 font-medium">المباع</span>
              <span className="text-xl font-bold text-green-700">{after.solid}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-xl">
              <span className="text-gray-600 font-medium">اجمالي فلوس المباع</span>
              <span className="text-xl font-bold text-green-700">{after.totalMoney+"$"}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-xl">
              <span className="text-gray-600 font-medium">الفلوس الي برا</span>
      ...
      <div className="relative z-10 pt-6 border-t border-gray-100">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-gray-800"> عملية تاجر {trader.traderName }</p>            
          ...
          <Link to={`/home/trader/${trader.traderName}`}>
